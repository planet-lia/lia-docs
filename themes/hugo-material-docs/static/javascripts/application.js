// Original: https://github.com/squidfunk/mkdocs-material/tree/master/src/assets
...
if ("document"in self && ("classList"in document.createElement("_") ? !function() {
    ...
    if ("Element"in t) {
        var e = "classList"
            ...
            , l = function(t) {
            for (var e = r.call(t.getAttribute("class") || ""), n = e ? e.split(/\s+/) : [], o = 0, i = n.length; i > o; o++)
                this.push(n[o]);
        ...
        if (a[n] = Error[n],
                ...
                do
                    for (t = n[o] + "",
                        ...
                        this.splice(e, 1),
                            r = !0,
                            e = c(this, t);
                while (++o < i);r && this._updateClassName()
            }
            ,
            ...
            try {
                ...
                -2146823252 === f.number && (h.enumerable = !1,
                    i.defineProperty(o, e, h))
            }
        } else
            i[n].__defineGetter__ && o.__defineGetter__(e, d)
    }
}(self)),
    function() {
        "use strict";
        ...
        t.prototype.needsClick = function(t) {
            ...
            t.prototype.onTouchEnd = function(t) {
                ...
                "label" === a) {
                    ...
                    return t.timeStamp - s > 100 || o && window.top !== window && "input" === a ? (this.targetElement = null,
                        !1) : (this.focus(u),
                        this.sendClick(u, t),
                    o && "select" === a || (this.targetElement = null,
                        t.preventDefault()),
                        !1);
                return o && !i && (c = u.fastClickScrollParent,
                c && c.fastClickLastScrollTop !== c.scrollTop) ? !0 : (this.needsClick(u) || (t.preventDefault(),
                    this.sendClick(u, t)),
                    !1)
            }
            ,
            ...
            t.notNeeded = function(t) {
                ...
                if (s && (i = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/),
        ...
        t.version = "0.6.0",
            ...
            t.Pipeline.prototype.run = function(t) {
                for (var e = [], n = t.length, o = this._stack.length, i = 0; n > i; i++) {
                    for (var r = t[i], s = 0; o > s && (r = this._stack[s](r, i, t),
                    void 0 !== r && "" !== r); s++)
                        ;
                    void 0 !== r && "" !== r && e.push(r)
                }
            ...
            t.Vector.prototype.insert = function(e, n) {
                ...
                var o = this.list;
                if (!o)
                    return this.list = new t.Vector.Node(e,n,o),
                        this.length++;
                if (e < o.idx)
                    return this.list = new t.Vector.Node(e,n,o),
                        this.length++;
                for (var i = o, r = o.next; void 0 != r; ) {
                    if (e < r.idx)
                        return i.next = new t.Vector.Node(e,n,r),
                            this.length++;
                    i = r,
                        r = r.next
                }
            ...
            t.Vector.prototype.dot = function(t) {
                for (var e = this.list, n = t.list, o = 0; e && n; )
                    e.idx < n.idx ? e = e.next : e.idx > n.idx ? n = n.next : (o += e.val * n.val,
                        e = e.next,
                        n = n.next);
                return o
            }
            ...
            t.SortedSet.prototype.intersect = function(e) {
                for (var n = new t.SortedSet, o = 0, i = 0, r = this.length, s = e.length, a = this.elements, c = e.elements; ; ) {
                    if (o > r - 1 || i > s - 1)
                        break;
                    a[o] !== c[i] ? a[o] < c[i] ? o++ : a[o] > c[i] && i++ : (n.add(a[o]),
                        o++,
                        i++)
                }
                return n
            ...
            t.Index.prototype.add = function(e, n) {
                ...
                this._fields.forEach(function(n) {
                    ...
                    o[n.name] = r,
                        t.SortedSet.prototype.add.apply(i, r)
                }, this),
            ...
            t.Index.prototype.idf = function(t) {
                ...
                var n = this.tokenStore.count(t)
                    , o = 1;
                return n > 0 && (o = 1 + Math.log(this.documentStore.length / n)),
                    this._idfCache[e] = o
            }
            ,
            t.Index.prototype.search = function(e) {
                ...
                n.forEach(function(e, n, s) {
                    var a = 1 / s.length * this._fields.length * r
                        ...
                        for (var h = c.tokenStore.get(i), f = Object.keys(h), p = f.length, m = 0; p > m; m++)
                            u.add(h[f[m]].ref);
                        return n.union(u)
                    }, new t.SortedSet);
                    i.push(l)
            ...
            t.Store.load = function(e) {
                ...
                return n.length = e.length,
                    n.store = Object.keys(e.store).reduce(function(n, o) {
                        return n[o] = t.SortedSet.load(e.store[o]),
                            n
                    }, {}),
                    n
            }
            ...
            t.TokenStore.prototype.add = function(t, e, n) {
                ...
                return o in n || (n[o] = {
                    ...
                    0 === i.length ? (n[o].docs[e.ref] = e,
                        void (this.length += 1)) : this.add(i, e, n[o])
            }
            ,
            ...
            t.TokenStore.prototype.expand = function(t, e) {
                var n = this.getNode(t)
                    , o = n.docs || {}
                    , e = e || [];
                return Object.keys(o).length && e.push(t),
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var s = window.pageYOffset
            ...
            t > document.body.clientHeight - (96 - n) ? "absolute" != e.style.position && (e.style.position = "absolute",
                e.style.top = null,
                e.style.bottom = 0) : e.offsetHeight < window.innerHeight ? "fixed" != e.style.position && (e.style.position = "fixed",
                e.style.top = 0,
                e.style.bottom = null) : "fixed" != e.style.position ? t > e.offsetTop + e.offsetHeight ? (e.style.position = "fixed",
                e.style.top = null,
                e.style.bottom = "-96px") : window.pageYOffset < e.offsetTop && (e.style.position = "fixed",
                e.style.top = 0,
                e.style.bottom = null) : window.pageYOffset > s ? e.style.top && (e.style.position = "absolute",
                e.style.top = Math.max(0, s) + "px",
                e.style.bottom = null) : e.style.bottom && (e.style.position = "absolute",
            ...
            window.removeEventListener("scroll", a),
                matchMedia("only screen and (max-width: 959px)").matches ? (e.style.position = null,
                    e.style.top = null,
                    e.style.bottom = null) : e.offsetHeight + 96 < t.offsetHeight && (window.addEventListener("scroll", a),
                    a())
        };
        Modernizr.ios || (window.addEventListener("resize", c),
            c());
        var l = function() {
            pegasus(base_url + "/mkdocs/search_index.json").then(function(e, n) {
                ...
                e.docs.map(function(t) {
                    t.location = base_url + t.location,
                        s[t.location] = t,
                        o.add(t)
                }),
                    i.addEventListener("keyup", function() {
                        for (var e = document.querySelector(".results .list"); e.firstChild; )
                        ...
                        a.map(function(n) {
                            ...
                            l[0] == document.location.href.split("#")[0] && a.addEventListener("click", function(e) {
                                if (document.body.classList.remove("toggle-search"),
                                    document.body.classList.remove("locked"),
                                    t.checked = !1,
                                !matchMedia("only screen and (min-width: 960px)").matches && (e.preventDefault(),
                                    e.stopPropagation(),
                                1 != l.length)) {
                        ...
                        for (c.innerHTML = a.length + " search result" + (1 != a.length ? "s" : ""); r.firstChild; )
                            r.removeChild(r.firstChild);
                        r.appendChild(c)
                    })
            }, function(t, e) {
        ...
        t.addEventListener("click", function(t) {
            ...
            e.contains("locked") ? (e.remove("locked"),
            n && setTimeout(function() {
                window.scrollTo(0, u)
            }, 100)) : (u = window.scrollY,
            n && setTimeout(function() {
                window.scrollTo(0, 0)
            }, 400),
                setTimeout(function() {
                    this.checked && (n && e.add("locked"),
                        setTimeout(function() {
                            i.focus()
                        }, 200))
                }
        ...
        document.addEventListener("scroll", function() {
            for (var t = window.scrollY + window.innerHeight / 3, e = h.length - 1, o = 0; e > o; o++)
                t < h[o + 1] && (e = o);
            e != f && (f = e,
...
"standalone"in window.navigator && window.navigator.standalone) {
    ...
    document.addEventListener("click", function(t) {
        ...
        "href"in node && -1 !== node.href.indexOf("http") && (-1 !== node.href.indexOf(document.location.host) || remotes) && (t.preventDefault(),
